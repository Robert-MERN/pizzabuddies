        ...
        >
            <div className='w-full md:w-[500px]' >
                ...
                <div className='w-full flex justify-end gap-3 p-[20px] ' >
                    <button onClick={() => toggle_modal("delete_menu_modal")} className='bg-slate-200 hover:opacity-85 active:opacity-60 px-[14px] py-[8px] md:py-[10px] rounded text-stone-700 text-[12px] font-medium md:text-[15px] transition-all' >Cancel</button>
